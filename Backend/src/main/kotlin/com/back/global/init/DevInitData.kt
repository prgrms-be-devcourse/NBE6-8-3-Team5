...
class DevInitData(
    ...
    fun fakeNewsInit() {
        ...
        // 페이크뉴스 리스트 생성 및 저장
        val fakeNewsList = listOf<FakeNewsDto>(
            fakeNews1,
            fakeNews2,
            fakeNews3,
            fakeNews4,
    ...
    fun detailQuizInit() {
        ...
        detailQuizService.saveQuizzes(1L, listOf<DetailQuizDto>(quiz1, quiz2, quiz3))
        ...
        detailQuizService.saveQuizzes(2L, listOf<DetailQuizDto>(quiz4, quiz5, quiz6))
        ...
        detailQuizService.saveQuizzes(3L, listOf<DetailQuizDto>(quiz7, quiz8, quiz9))
        ...
        detailQuizService.saveQuizzes(4L, listOf<DetailQuizDto>(quiz10, quiz11, quiz12))
        ...
        detailQuizService.saveQuizzes(5L, listOf<DetailQuizDto>(quiz13, quiz14, quiz15))
        ...
        detailQuizService.saveQuizzes(6L, listOf<DetailQuizDto>(quiz16, quiz17, quiz18))
        ...
        detailQuizService.saveQuizzes(7L, listOf<DetailQuizDto>(quiz19, quiz20, quiz21))
    }
